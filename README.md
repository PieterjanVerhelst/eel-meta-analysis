...
14. `calculate_migration_speed.R`: Calculate the migration speed as the speed between the first and last detection and relate it to geographical position and sex
