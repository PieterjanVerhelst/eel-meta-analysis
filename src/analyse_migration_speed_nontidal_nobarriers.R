# Analyse the migration speed in non-tidal area free of barriers according to size, sex and geographical location
...
sex_project <- filter(migration_speed_nontidal_nobarriers, animal_project_code == "Frome")
#sex_project <- filter(migration_speed_nontidal_nobarriers, animal_project_code == "Grote Nete")
#sex_project <- filter(migration_speed_nontidal_nobarriers, animal_project_code == "Mondego")
