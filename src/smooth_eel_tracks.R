...
distance_matrix <- read_csv("./data/external/distance_matrices/distancematrix_2014_frome.csv")
...
# Write csv
write.csv(residency, "./data/interim/residencies/residency_2014_frome.csv")
