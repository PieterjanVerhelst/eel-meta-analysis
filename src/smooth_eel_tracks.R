...
subset <- filter(data, animal_project_code == "2011_Loire")
head(subset)
remove(data)
...
distance_matrix <- read_csv("./data/external/distance_matrices/distancematrix_2011_loire.csv")
...
# Write csv
write.csv(residency, "./data/interim/residencies/residency_2011_loire.csv")
