...
subset <- filter(data, animal_project_code == "2019_Grotenete")
head(subset)
remove(data)
...
distance_matrix <- read_csv("./data/external/distance_matrices/distancematrix_2019_grotenete.csv")
...
# Write csv
write.csv(residency, "./data/interim/residencies/residency_2019_grotenete.csv")
