...
subset <- filter(data, animal_project_code == "2013_Stour")
head(subset)
...
distance_matrix <- read_csv("./data/external/distance_matrices/distancematrix_2013_stour.csv")
...
# Write csv
write.csv(residency, "./data/interim/residencies/residency_2013_stour.csv")
