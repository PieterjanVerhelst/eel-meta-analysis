...
# Upload dataset
data <- read_csv('./data/interim/migration/migration_2019_grotenete.csv') 
data$...1 <- NULL
data$...2 <- NULL
...
pdf("./figures/distance_tracks/migration/distance_tracks_2019_grotenete_migration.pdf") # Create pdf
