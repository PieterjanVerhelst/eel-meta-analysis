...
# Upload dataset
data <- read_csv('./data/interim/speed/speed_2014_nene.csv') 
data$...1 <- NULL
data$...2 <- NULL
...
pdf("./figures/distance_tracks/distance_tracks_2014_nene.pdf") # Create pdf
...
for (i in 1:length(mydfnew.split.eel)){ #i van 1 tot aantal transmitters
  ...
  g <- g + scale_y_continuous(limit = c(-85000, 0),breaks = c(-85000, -80000, -75000, -70000, -65000, -60000, -55000, -50000, -45000, -40000, -35000, -30000, -25000, -20000, -15000, -10000, -5000, 0), labels = c(-85,-80,-75,-70,-65,-60,-55,-50,-45,-40,-35,-30,-25,-20,-15,-10,-5,0))
